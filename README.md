...
* logic permutations - A help script to solve  Cryptic crossword definition in the kind of anagram. Using comperison of permutations matching the expectedone , and find it in specific (Dictionaries & Word Lists)[https://github.com/NNLP-IL/Resources#dictionaries-word-lists]. e.g. י רושלים = של מי יור
